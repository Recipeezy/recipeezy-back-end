...
urlpatterns = [
    ...
    path('ingredients/<int:pk>/to_pantry/', views.IngredientToPantry.as_view()),
    path('ingredients/<int:pk>/to_shoplist/', views.IngredientToShopList.as_view()),
    path('ingredients/swap_all/<int:pk>/', views.IngredientSwapAll.as_view()),
